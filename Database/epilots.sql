...
--
-- Host: localhost
-- Generation Time: Aug 04, 2022 at 08:17 AM
...
-- Database: `epilots`
--
CREATE DATABASE IF NOT EXISTS `epilots` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `epilots`;
...
('1jftc8rsk9nw5wfjbdquj9yu7ek0t56i', 'eyJ1c2VyaWQiOjJ9:1oJVu6:H8jc7UPqeswctKMXUSw8OaFaNhZ1mzWE8k6SnDFDsVo', '2022-08-18 08:08:26.932669'),
...
('z8z86t08u9oxox9uvvt0if5lh6wced0f', 'eyJ1c2VyaWQiOjF9:1oJUA9:-pwYCD1A6WGpNQ0RvsHDBVO4OhHpIDg95qnRRc9UpU8', '2022-08-18 06:16:53.974519'),
...
(1, 'Hari', 'Hari123@gmail.com', 'Hari', '9535866270', 'India', 'Karnataka', 'Bangalore', '#892,4th Cross,Malleshwaram', 'Male'),
(2, 'Manjunath', 'tmksmanju132@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#098,4th Cross,Rajajinagar', 'Male');
...
(46, 'Naive Bayes', '52.635500093127206'),
(47, 'SVM', '52.635500093127206'),
(48, 'Logistic Regression', '52.635500093127206'),
(49, 'Decision Tree Classifier', '52.635500093127206'),
(50, 'SGD Classifier', '52.635500093127206');
...
(11, 'Hard Landing', '75.0'),
(12, 'Soft Landing', '25.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_epilots_landing_type`
--

CREATE TABLE IF NOT EXISTS `remote_user_epilots_landing_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Activity_Id` varchar(3000) NOT NULL,
  `Landing_Airport` varchar(3000) NOT NULL,
  `Airline_Name` varchar(3000) NOT NULL,
  `Operating_Airline_IATA_Code` varchar(3000) NOT NULL,
  `Landing_Date` varchar(3000) NOT NULL,
  `Published_Airline` varchar(3000) NOT NULL,
  `Published_Airline_IATA_Code` varchar(3000) NOT NULL,
  `GEO_Summary` varchar(3000) NOT NULL,
  `GEO_Region` varchar(3000) NOT NULL,
  `Landing_Aircraft_Type` varchar(3000) NOT NULL,
  `Aircraft_Body_Type` varchar(3000) NOT NULL,
  `Aircraft_Manufacturer` varchar(3000) NOT NULL,
  `Aircraft_Model` varchar(3000) NOT NULL,
  `Aircraft_Version` varchar(3000) NOT NULL,
  `Landing_Count` varchar(3000) NOT NULL,
  `Total_Landed_Weight` varchar(3000) NOT NULL,
  `Prediction` varchar(3000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=6 ;

--
-- Dumping data for table `remote_user_epilots_landing_type`
--

INSERT INTO `remote_user_epilots_landing_type` (`id`, `Activity_Id`, `Landing_Airport`, `Airline_Name`, `Operating_Airline_IATA_Code`, `Landing_Date`, `Published_Airline`, `Published_Airline_IATA_Code`, `GEO_Summary`, `GEO_Region`, `Landing_Aircraft_Type`, `Aircraft_Body_Type`, `Aircraft_Manufacturer`, `Aircraft_Model`, `Aircraft_Version`, `Landing_Count`, `Total_Landed_Weight`, `Prediction`) VALUES
(2, '51045', 'Southwest Georgia Regional Airport', 'Air Canada', 'AC', '05-01-21', 'International', 'AC', 'International', 'Canada', 'Passenger', 'Wide Body', 'Boeing', '767', '333', '1', '320000', 'Soft Landing'),
(3, '26007', 'Adak Airport', 'Air France', 'AF', '10-01-21', 'Air France', 'AF', 'International', 'Europe', 'Passenger', 'Wide Body', 'Boeing', '747', '400', '31', '18855500', 'Hard Landing'),
(4, '141949', 'Alexandria International Airport', 'AirTran Airways', 'FL', '12-01-21', 'AirTran Airways', 'FL', 'Domestic', 'US', 'Passenger', 'Narrow Body', 'Boeing', '737', '700', '62', '7936000', 'Hard Landing'),
(5, '146401', 'Ted Stevens Anchorage International Airport', 'Alaska Airlines', 'AS', '18-01-21', 'Alaska Airlines', 'AS', 'Domestic', 'US', 'Passenger', 'Narrow Body', 'Boeing', '737', '800', '1', '144000', 'Hard Landing');
