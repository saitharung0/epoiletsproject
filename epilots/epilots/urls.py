...
urlpatterns = [
    ...
    url(r'^Predict_Landing_Type/$', remoteuser.Predict_Landing_Type, name="Predict_Landing_Type"),
    ...
    url(r'^View_Prediction_Of_Flight_Landing_Type_Ratio/$', serviceprovider.View_Prediction_Of_Flight_Landing_Type_Ratio, name="View_Prediction_Of_Flight_Landing_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Flight_Landing_Type/$', serviceprovider.View_Prediction_Of_Flight_Landing_Type, name="View_Prediction_Of_Flight_Landing_Type"),
